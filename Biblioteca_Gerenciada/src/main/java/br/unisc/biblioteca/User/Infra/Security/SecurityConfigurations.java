package br.unisc.biblioteca.User.Infra.Security;
...
public class SecurityConfigurations {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000/")); // Substitua com o padrão que se aplica às suas origens
